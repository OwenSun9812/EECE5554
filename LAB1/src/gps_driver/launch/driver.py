...
>>>>>>> b2013f3ecfd562dd706743ce8c7c8ae12357738d
	<group if="$(arg gps_moving)">
		<node name="bag_record" pkg="rosbag" type="record" args=" -O /home/owensun/eece5554/LAB1/src/data/walk" />
	</group>
	<group unless="$(arg gps_moving)">
		<node name="bag_record" pkg="rosbag" type="record" args=" -O /home/owensun/eece5554/LAB1/src/data/stay" />
	</group>
-->
</launch>
